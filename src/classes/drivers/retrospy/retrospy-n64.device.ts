...
/*
	RetroSpyDevice_N64
	Parses the input from a nintendo 64 controller and parses it into an chromium gamepad response.
...
*/
export default class RetroSpyDevice_N64 extends RetroSpyAxisDevice {
	constructor() {
		super(2, 12, "RetroSpy Ardunio Nintendo 64. 12 Buttons, 2 Axes");
