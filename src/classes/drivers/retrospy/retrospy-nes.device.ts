...
/*
	RetroSpyDevice_NES
	Parses the input from a famicom controller and parses it into an chromium gamepad response.
...
*/
export default class RetroSpyDevice_NES extends RetroSpyDevice {

	constructor() {
		super(0, 8, "RetroSpy Ardunio Nintendo Famicom (NES). 8 Buttons, 0 Axes");
	}
